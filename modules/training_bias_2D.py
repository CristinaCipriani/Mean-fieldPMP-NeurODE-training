...
def parameter_update(Z_trace, g, psi_pos, psi_neg, der_omega_F1, der_omega_F2, der_sigma_F1, der_sigma_F2, theta, Lambda, x1 , x2, dx , dt, Nx, Nt, mid_point):
...
def MFOC(N, d, T, dt, R, mu_0, center_left, center_right, y_left, y_right, xmin, xmax, grid_points, theta, F, mid_point, Lambda, num_iterations):
    # Creation of the initial distribution according to user's choice
    ...
    for k in range(0,num_iterations):
        ...
        theta, count, loss_fct = parameter_update(Z_trace, g, psi_pos, psi_neg, der_omega_F1, der_omega_F2, der_sigma_F1, der_sigma_F2, theta, Lambda, x1 , x2, dx , dt, Nx, Nt, mid_point)
        counts[k] = count
